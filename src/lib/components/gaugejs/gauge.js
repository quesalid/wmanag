...
//export default (function () {
    ...
    Gauge = (function (superClass) {
        ...
        function Gauge(canvas) {
            console.log("GAUGE CONSTRUCTOR _________________________",canvas)
            var h, w;
            this.canvas = canvas;
            ...
            console.log("GAUGE CONSTRUCTOR _________________________", this.canvas.height, this.canvas.width, h, w)
            if(h)
